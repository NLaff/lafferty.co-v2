...
A landing page is designed to convert an anonymous visitor into a customer or lead. Landing pages typically have a single goal so it's advisible to remove any links or escape points that could entice a visitor to leave. 
...
![Modernize Landing Page Example](/uploads/Modernize_Landing_Page.png)

### Clearbanc
Fundraising Lead Gen, United Kingdom
![Clearbanc Landing Page Example](/uploads/Clearbanc_Landing_Page.png)

### Setapp
SaaS providing a curated bundle of Mac and iOS apps. 
![Setapp Landing Page Example](/uploads/Setapp_Landing_Page.png)
...
Scroll down to compare [Unbounce](https://unbounce.grsm.io/nicklafferty), [Instapage](https://instapage.grsm.io/nicklafferty), and [Leadpages](https://leadpages.com).

### Unbounce
![Unbounce Logo](/uploads/unbounce-identity-gray.png)
I have used [Unbounce](https://unbounce.grsm.io/nicklafferty) for years at my day job and have become really familiar with it's strengths and weaknesses.
...
#### Features
![Unbounce PPC Feature](/uploads/unbounce_builder_ppcad.png)
...
![Unbounce Pricing 2021](/uploads/Unbounce_Pricing_2021.png)

[Unbounce](https://unbounce.grsm.io/nicklafferty) starts at $80/month and goes as high as $300/month. However, even the $300/month plan is limited to 50,000 visitors/month which is not very many. Once you go beyond that you'll need a custom plan, which is likely much more expensive. 
...
### Instapage
[Instapage](https://instapage.grsm.io/nicklafferty) is the cadillac of landing page tools reviewed here. It's also the most expensive, starting at $199/month. If you have more than 30,000 visitiors/month then you'll need their Enterprise plan. Expect their Enterprise plan to cost in the thousands of dollars per month. 
...
![Instapage AB Testing](/uploads/Experimentation3_variationorABtesting@2x.png)
...
#### Features
![Instapage AMP Support](/uploads/Builder4_AMPLandingPages@2x.png)
...
![Instapage real time collaboration](/uploads/Collaboration2_Real-TimeEdits@2x.png)
Only Instapage has real-time collaboration, to where multiple people can edit the same page at the same time.
...
* There are differences in Javascript load for both websites
...
![Unbounce Analytics Screenshot](/uploads/Unbounce_Analytics.png)
...
#### Pricing
![Leadpages Pricing 2021](/uploads/Leadpages_Pricing.png)
...
Leadpages is the cheapest landing page tool I reviewed so far. Some of their features lag behind Unbounce and Instapage, but for anyone looking to build a cheap landing page with unlimited users/month, Leadpages has the lowest cost. 

**Winner**: [Leadpages](https://www.leadpages.com)